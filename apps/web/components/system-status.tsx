...
export function SystemStatus() {
  ...
  const label = !health ? "Checking services" : ready ? "Foundation online" : "Service attention needed";
    ...
    <Card>
      ...
      <CardContent aria-live="polite" aria-atomic="true">
        ...
        <p className="mt-5 border-t border-border pt-4 text-xs leading-relaxed text-muted-foreground">
          Infrastructure health only. Hazard detection and worker monitoring are not active in Phase 1.
        </p>
      </CardContent>
    </Card>
  );
